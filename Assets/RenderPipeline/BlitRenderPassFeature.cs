...
public class BlitRenderPassFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        {
            _material = material;
            _tempRenderTargetHandle.Init("_TemporaryColorTexture");
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            commandBuffer.GetTemporaryRT(_tempRenderTargetHandle.id, renderingData.cameraData.cameraTargetDescriptor);
            Blit(commandBuffer, source, _tempRenderTargetHandle.Identifier(), _material);
            Blit(commandBuffer, _tempRenderTargetHandle.Identifier(), source);
